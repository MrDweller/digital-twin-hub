...
\ArrowheadTitle{remove-digital-twin} % XXX = ServiceName 
\ArrowheadServiceID{remove-digital-twin} % ID name of service
...
\begin{center}
  ...
  % Front Page Abstract
  \begin{abstract}
    This document provides service description for the \textbf{remove-digital-twin} service. 
  \end{abstract}
...
\section{Overview}
\label{sec:overview}
This document describes the \textbf{remove-digital-twin} service, which makes it possible to remove a digital twin. The service will remove and deregister all services associated with the digital twin and remove the digital twin from the digital twin hub database. 
...
The system operator should use the \textbf{remove-digital-twin} service when it is no longer desired to have that digital twin system in the local cloud. 
...
This section describes the interfaces to the service. The \textbf{remove-digital-twin} service is used to remove a digital twin system. Various parameters are representing the necessary system input information.
...
Here, all data objects that can be part of the \textbf{remove-digital-twin} service
